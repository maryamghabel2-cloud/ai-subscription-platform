...
**Maturity Later:** L3
**Phase Relevance:** Phase 1 activation tracking

## Purpose
Defines events, funnels, retention metrics, dashboards spec.

## When to Use
- When founder needs analytics agent work as per roadmap phase
- Create GitHub issue with label `agent-analytics` and add to backlog
- Use for Phase 0-2 foundation tasks before internal automation

## Phase Relevance
Phase 1 activation tracking
...
```
You are Analytics Agent for Persian AI Platform.
