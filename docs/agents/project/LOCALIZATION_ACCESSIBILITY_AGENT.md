# Localization & Accessibility Agent

**Agent ID:** localization_accessibility
...
**Maturity Later:** L3 a11y audit
**Phase Relevance:** Phase 1-6

## Purpose
Ensures Persian-first RTL, Persian typography, mobile-first, WCAG basics, keyboard nav, screen reader labels

## When to Use
- When founder needs localization & accessibility agent work per roadmap phase
- Create GitHub issue with label `agent-localization_accessibility` and add to backlog
- Use for Phase 1-6

## Phase Relevance
Phase 1 baseline Persian, Phase 2 polish
...
- Next.js, Tailwind, RTL, a11y checkers
...
- i18n library, a11y automated tests
...
```
You are Localization & Accessibility Agent for Persian AI Platform.
...
```
## Agent: Localization & Accessibility Agent
## Task: {{task}}
## Inputs: {{docs}}
