...
## Purpose
Writes tests, security checks, gitleaks, dependency audit.

## When to Use
- When founder needs qa/security agent work as per roadmap phase
- Create GitHub issue with label `agent-qa_security` and add to backlog
...
```
You are QA/Security Agent for Persian AI Platform.
