...
## Purpose
Researches AI model providers, pricing, alternatives, for build vs buy.

## When to Use
- When founder needs supplier scout agent work as per roadmap phase
- Create GitHub issue with label `agent-supplier_scout` and add to backlog
- Use for Phase 0-2 foundation tasks before internal automation

## Phase Relevance
Phase 0, Phase 3 image, Phase 5 video
...
```
You are Supplier Scout Agent for Persian AI Platform.
