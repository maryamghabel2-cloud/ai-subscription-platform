...
**Agent ID:** growth_marketing
**Type:** Project-Building (Founder to Build Product)
**Maturity Now:** L2 Semi-automated external agent with PR/report output
**Maturity Later:** L3
**Phase Relevance:** Phase 0 growth system, launch

## Purpose
Growth loops, activation experiments, pricing tests, referral ideas.

## When to Use
- When founder needs growth marketing agent work as per roadmap phase
- Create GitHub issue with label `agent-growth_marketing` and add to backlog
- Use for Phase 0-2 foundation tasks before internal automation

## Phase Relevance
Phase 0 growth system, launch
...
```
You are Growth Marketing Agent for Persian AI Platform.
