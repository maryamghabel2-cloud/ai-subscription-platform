...
**Agent ID:** data_privacy_governance
...
**Maturity Later:** L3 read-only privacy audit
**Phase Relevance:** Phase 0-7

## Purpose
Defines data classification, retention, privacy, GDPR-like principles, wallet ledger privacy, user data deletion

## When to Use
- When founder needs data privacy governance agent work per roadmap phase
- Create GitHub issue with label `agent-data_privacy_governance` and add to backlog
- Use for Phase 0-7
...
```
You are Data Privacy Governance Agent for Persian AI Platform.
