...
## Purpose
Reviews persona risks, content safety, ToS, red teaming.

## When to Use
- When founder needs compliance/risk agent work as per roadmap phase
- Create GitHub issue with label `agent-compliance_risk` and add to backlog
...
```
You are Compliance/Risk Agent for Persian AI Platform.
