...
**Maturity Later:** L3
**Phase Relevance:** Phase 0 foundation, Phase 7 RAG

## Purpose
Deep research on AI models, Persian UX, competitors, RAG.

## When to Use
- When founder needs research agent work as per roadmap phase
- Create GitHub issue with label `agent-research` and add to backlog
- Use for Phase 0-2 foundation tasks before internal automation

## Phase Relevance
Phase 0 foundation, Phase 7 RAG
...
```
You are Research Agent for Persian AI Platform.
