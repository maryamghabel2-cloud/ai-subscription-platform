...
**Maturity Later:** L3
**Phase Relevance:** Phase 1-4 core MVP, API platform

## Purpose
Builds FastAPI + Next.js features in branches, opens PRs.

## When to Use
- When founder needs fullstack builder agent work as per roadmap phase
- Create GitHub issue with label `agent-fullstack_builder` and add to backlog
- Use for Phase 0-2 foundation tasks before internal automation

## Phase Relevance
Phase 1-4 core MVP, API platform
...
```
You are Fullstack Builder Agent for Persian AI Platform.
